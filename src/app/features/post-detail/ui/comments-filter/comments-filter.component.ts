...
export class CommentsFilterComponent {
  ...
  readonly postDetailStore = inject(PostDetailStore);
  ...
  getSelectedFilterLabel(): string {
    ...
    return this.postDetailStore.getSelectedFilterLabel();
  }
  ...
  applyFilter(event: Event, filter: string): void {
    ...
    this.postDetailStore.setFilterForComments(filter);
